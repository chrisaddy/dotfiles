...

{
  xdg.configFile."zellij/config.kdl".text = ''
    keybinds {
        ...
        locked {
            ...
            bind "Ctrl m" { MoveFocus "Left"; SwitchToMode "Locked"; }
            bind "Ctrl n" { MoveFocus "Down"; SwitchToMode "Locked"; }
            bind "Ctrl e" { MoveFocus "Up"; SwitchToMode "Locked"; }
            bind "Ctrl i" { MoveFocus "Right"; SwitchToMode "Locked"; }
            bind "Esc [105;5u" { MoveFocus "Right"; SwitchToMode "Locked"; }
        }

        move {
            bind "m" { MovePane "Left"; SwitchToMode "Locked"; }
            bind "n" { MovePane "Down"; SwitchToMode "Locked"; }
            bind "e" { MovePane "Up"; SwitchToMode "Locked"; }
            bind "i" { MovePane "Right"; SwitchToMode "Locked"; }
        }
  ...
  xdg.configFile."zellij/layouts/tmux.kdl".text = ''
    // layout {
